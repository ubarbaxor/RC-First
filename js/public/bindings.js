...
const loadBindings = _ => { // eslint-disable-line no-unused-vars
...
const persistBindings = _ => { // eslint-disable-line no-unused-vars
  window.localStorage.bindings = JSON.stringify(bindings)
}
const clearBindings = _ => { // eslint-disable-line no-unused-vars
  bindings.axes = {}
  bindings.buttons = {}
